# -> todo 17/11/2022 2.5h, NA, NA, NA, from 2:50 pm to 8:47 am, set TestString_Bytes_Count to 5, set TestString to 0x31426f45, 0x3030714d, 0x3130303036, 0x3030302f
#
...
print(str(ID))
with open("User_beta.build8allcasealphanumeric.txt", "r") as log_file:
    ...
    try:
        ...
        for b in range(-1, -TestString_Bytes_Count - 1, -1):
            if (0x39 >= TestString_bytes[b] >= 0x30) or (0x7a >= TestString_bytes[b] >= 0x61):
                ...
                TestString += (0x6) * (0x100 ** (-b-1))
            elif TestString_bytes[b] == 0x5b:
                TestString += (0x5) * (0x100 ** (-b - 1))
        ...
        with open("User_beta.build8allcasealphanumeric.txt", "w") as log_file:
